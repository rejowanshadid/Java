...
public class CusLogin extends JFrame implements ActionListener{
    ...
    public CusLogin ()
    {
        this.setTitle(" You are interacting as Customer ");
    ...
    //button
	   ...
	   b1.setBackground(new Color(118, 194, 175));
	   b1.setBounds(450,340,225,27);
	   ...
	   b3 = new JButton("Back");
       b3.setFont(new Font("Georgia", Font.PLAIN, 16));
       b3.setForeground(Color.white);
       b3.setBackground(new Color(210, 4, 45));
       b3.setBounds(450, 380, 225, 27);
		...
		else if(ae.getSource()==b2)
		{
			if(t1.getText().length() <=0 || pa1.getText().length() <=0){
				...
				try {
					...
					BufferedReader reader = new BufferedReader(new FileReader("data\\cusData.txt"));
					...
					for (int i = 0; i <= totalLines; i++) {
						String line = Files.readAllLines(Paths.get("data\\cusData.txt")).get(i);

						if (line.equals(userNameS)) {
							String line2 = Files.readAllLines(Paths.get("data\\cusData.txt")).get((i + 1));
							...
							if (line2.equals(passwordS)) {
							  ...
							  String line3 = Files.readAllLines(Paths.get("data\\cusData.txt")).get((i + 2));
							  String line4 = Files.readAllLines(Paths.get("data\\cusData.txt")).get((i + 3));
							  String line5 = Files.readAllLines(Paths.get("data\\cusData.txt")).get((i + 4));
