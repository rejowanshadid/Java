...
public class OwnerLogin extends JFrame implements ActionListener {
    ...
    public OwnerLogin() {
        this.setTitle("You are interacting as Owner");
        ...
        if (ae.getSource() == b1) {
            ...
            if (t1.getText().length() <= 0 || pa1.getPassword().length <= 0) {
                ...
                try {
                    ...
                    BufferedReader reader = new BufferedReader(new FileReader("data\\ownerData.txt"));
                    ...
                    for (int i = 0; i <= totalLines; i++) {
                        String line = Files.readAllLines(Paths.get("data\\ownerData.txt")).get(i);

                        if (line.equals(userNameS)) {
                            String line2 = Files.readAllLines(Paths.get("data\\ownerData.txt")).get((i + 1));
                            ...
                            if (line2.equals(passwordS)) {
                                ...
                                String line3 = Files.readAllLines(Paths.get("data\\ownerData.txt")).get((i + 2));
                                String line4 = Files.readAllLines(Paths.get("data\\ownerData.txt")).get((i + 3));
                                String line5 = Files.readAllLines(Paths.get("data\\ownerData.txt")).get((i + 4));
