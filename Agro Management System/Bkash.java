...
public class Bkash implements ActionListener{  
   ...
   public Bkash(){  
        ...
        lusn = new JLabel ("BKASH Number");
        lpass = new JLabel ("BKASH PIN");
 ...
 ImageIcon img = new ImageIcon("D:\\meher\\Image\\bks.png");
...
background.setBackground(Color.decode("#F4BBD3"));
background.setOpaque(true);

     Container contentPane = frame.getContentPane();

        // Set the background color of the content pane
        contentPane.setBackground(Color.decode("#FF0090")); 
